...
module.exports = {
  ...
  SONG_QUERIES: {
    ...
    horror:       ['Tamil thriller song', 'Tamil horror BGM', 'Tamil suspense song',
                   'Tamil dark song', 'Tamil mystery songs', 'Tamil intense song',
                   'Tamil action song', 'Tamil background song', 'Tamil dark melody'],
  ...
  MINI_SONG_QUERIES: {
    ...
    horror:       ['Tamil thriller songs', 'Tamil horror songs', 'Tamil suspense songs', 'Tamil dark songs', 'Tamil mystery songs'],
